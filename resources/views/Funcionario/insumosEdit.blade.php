    ...
    <div class="py-12">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('funcionario.insumos.update', $insumo) }}" method="POST">
                    @csrf
                    @method('PUT')

                    <!-- Campos idénticos a create, pero con valores actuales -->
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input
                            ...
                            name="solicitante"
                            id="solicitante"
                            value="{{ old('solicitante', $insumo->solicitante) }}"
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            required
                        >
                        @error('solicitante')
                    ...
                    <div class="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                name="fecha_prestamo"
                                id="fecha_prestamo"
                                value="{{ old('fecha_prestamo', $insumo->fecha_prestamo->format('Y-m-d')) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                                required
                            >
                        ...
                        <div>
                            ...
                            <input
                                ...
                                id="fecha_devolucion"
                                value="{{ old('fecha_devolucion', optional($insumo->fecha_devolucion)->format('Y-m-d')) }}"
                                class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
                            >
                    ...
                    <div class="mb-6">
                        ...
                        <select
                            ...
                            required
                        >
                            <option value="Prestado" {{ old('estado', $insumo->estado)=='Prestado' ? 'selected' : '' }}>Prestado</option>
                            <option value="Devuelto" {{ old('estado', $insumo->estado)=='Devuelto' ? 'selected' : '' }}>Devuelto</option>
                        </select>
                        @error('estado')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
